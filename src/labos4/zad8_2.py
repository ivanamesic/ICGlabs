...
print("eps=100;m=16;u_min=-1;u_max=1;v_min=-1.2;v_max=1.2; c=0.32+0.043j")
...
c=complex(input("Upišite kompleksni broj u obliku x+yj: "))
...
def on_show():
    ...
    window.set_caption("Zadatak 8.3.2: Julijev fraktal")
